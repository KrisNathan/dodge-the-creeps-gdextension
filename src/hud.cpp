...
void HUD::_ready()
{
    ...
    _start_button->connect("pressed", godot::Callable(this, "_on_StartButton_pressed"));
    _start_message_timer->connect("timeout", godot::Callable(this, "_on_StartMessageTimer_timeout"));
    _get_ready_message_timer->connect("timeout", godot::Callable(this, "_on_GetReadyMessageTimer_timeout"));
}
...
void HUD::_bind_methods()
{
    ...
    godot::ClassDB::bind_method(godot::D_METHOD("show_get_ready"), &HUD::show_get_ready);
    godot::ClassDB::bind_method(godot::D_METHOD("show_game_over"), &HUD::show_game_over);
    godot::ClassDB::bind_method(godot::D_METHOD("update_score", "score"), &HUD::update_score);
