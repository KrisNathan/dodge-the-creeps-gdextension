...
void Main::_bind_methods()
{
    ...
    godot::ClassDB::bind_method(godot::D_METHOD("set_hud", "hud"), &Main::set_hud);
    godot::ClassDB::bind_method(godot::D_METHOD("get_hud"), &Main::get_hud);
    godot::ClassDB::bind_method(godot::D_METHOD("set_player", "player"), &Main::set_player);
    godot::ClassDB::bind_method(godot::D_METHOD("get_player"), &Main::get_player);
    godot::ClassDB::bind_method(godot::D_METHOD("set_start_position", "start_position"), &Main::set_start_position);
    godot::ClassDB::bind_method(godot::D_METHOD("get_start_position"), &Main::get_start_position);
    godot::ClassDB::bind_method(godot::D_METHOD("set_mob_spawn_location", "mob_spawn_location"), &Main::set_mob_spawn_location);
    godot::ClassDB::bind_method(godot::D_METHOD("get_mob_spawn_location"), &Main::get_mob_spawn_location);
    godot::ClassDB::bind_method(godot::D_METHOD("set_mob_timer", "mob_timer"), &Main::set_mob_timer);
    godot::ClassDB::bind_method(godot::D_METHOD("get_mob_timer"), &Main::get_mob_timer);
    godot::ClassDB::bind_method(godot::D_METHOD("set_score_timer", "score_timer"), &Main::set_score_timer);
    godot::ClassDB::bind_method(godot::D_METHOD("get_score_timer"), &Main::get_score_timer);
...
godot::Ref<godot::PackedScene> Main::get_mob_scene()
{
    return mob_scene;
}

void Main::set_hud(HUD *hud)
{
    _hud = hud;
};
HUD *Main::get_hud()
...
void Main::set_player(Player *player)
{
    _player = player;
};
...
godot::Node2D *Main::get_start_position(){
...
void Main::set_mob_timer(godot::Timer *mob_timer) {
    _mob_timer = mob_timer;
};
godot::Timer *Main::get_mob_timer() {
    return _mob_timer;
};
void Main::set_score_timer(godot::Timer *score_timer) {
    _score_timer = score_timer;
};
godot::Timer *Main::get_score_timer() {
    return _score_timer;
};
void Main::set_start_timer(godot::Timer *start_timer) {
    _start_timer = start_timer;
};
godot::Timer *Main::get_start_timer() {
    return _start_timer;
};